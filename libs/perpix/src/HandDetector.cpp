...
void HandDetector::testInitialize(string model_prefix,string globfeat_prefix, string feature_set, int knn, int width)
{
	...
	{ // This will only work on linux systems
		...
		filenames.push_back("/sdcard/handtracking/models/model__rvl_0_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_1_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_2_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_3_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_4_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_5_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_6_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_7_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_8_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_9_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_10_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_11_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_12_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_13_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_14_rdtr.xml");
		filenames.push_back("/sdcard/handtracking/models/model__rvl_15_rdtr.xml");
	...
	
	{
		...
		//string val;
		//while(fs>>val) filenames.push_back(val);
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_0.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_1.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_2.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_3.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_4.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_5.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_6.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_7.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_8.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_9.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_10.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_11.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_12.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_13.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_14.xml");
		filenames.push_back("/sdcard/handtracking/globfeat/hsv_histogram_15.xml");
		
		int num_models = (int)filenames.size();
		LOGD("num_models = %d", num_models);
	...
	if(_hist_all.rows != (int)_classifier.size()) LOGD("ERROR: Number of classifers doesn't match number of global features.\n");
	if(_hist_all.rows == (int)_classifier.size()) LOGD("Number of classifers matches number of global features. %d \n", _hist_all.rows);
	...
	LOGD("Building FLANN search structure...");
